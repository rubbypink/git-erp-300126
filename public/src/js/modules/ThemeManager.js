...
export default class ThemeManager {
  ...
  init() {
    ...
    log('✓ Theme Manager initialized with ' + this.currentTheme + ' theme', 'success');
  }
  ...
  applyTheme(themeName) {
    ...
    log('🎨 Theme applied: ' + themeName, 'info');
  }
  ...
  fillSettingsForm() {
    ...
    log(`✅ Form filled with [${this.currentTheme}] theme colors`, 'info');
  }
  ...
  setupColorSync() {
    const colorPairs = [
      'st-app-bg', 'st-header-bg', 'st-footer-bg',
      'st-tbl-head-bg', 'st-tbl-head-text',
      'st-tab-active-bg', 'st-tab-active-text',
      'st-tab-inactive-bg', 'st-tab-inactive-text',
      'st-glass-bg', 'st-glass-text',
      'st-btn-primary', 'st-btn-success', 'st-btn-danger',
      'st-btn-info', 'st-btn-secondary',
      'st-text-color', 'st-border-color',
      'st-surface-color', 'st-hover-bg', 'st-input-bg'
    ];
      ...
      if (picker && textEl) {
        ...
        picker.oninput = () => {
          ...
          if (presetEl && presetEl.value !== 'custom') {
            ...
            log('⚙️ Theme marked as custom (colors modified)', 'info');
          }
        };
      }
    });
  ...
  saveSettingsFromForm() {
    ...
    try {
      ...
      log('✅ Theme settings saved successfully', 'success');
      return true;
    } catch (e) {
