    ...
    static UI = {
        ...
        openFilterDialog: async () => {
            ...
            <div class="text-start mt-3">
                <div class="mb-3">
                    <label class="form-label fw-bold small  mb-1">Nhà cung cấp <span class="text-danger">*</span></label>
                    <select id="swal-supplier" class="smart-select form-select shadow-sm border-primary" data-source="suppliers"></select>
                </div>
                <div class="mb-3">
                    <label class="form-label fw-bold small  mb-1">Giai đoạn</label>
            ...
            <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    ...
                    <div class="d-flex gap-3 text-muted" style="font-size: 0.9rem;">
                        <span>Tổng tiền: <strong >${cost.toLocaleString()}</strong></span>
