...
export default class PriceImportAI {
    ...
    _buildUI() {
      ...
      <div class="ai-import-wrapper d-flex flex-column h-100" style="min-height: 80vh;">
          <div class="action-bar p-3 bg-surface-alt border-bottom sticky-top shadow-sm d-flex flex-wrap gap-2 align-items-center">
          ...
          <div class="flex-grow-1 p-0 overflow-auto bg-surface-alt d-flex flex-column">
              <div id="ai-hotel-info-container" class="d-none bg-surface-alt p-3 border-bottom shadow-sm"></div>
