...
class HotelPriceManager {
  ...
  async loadMasterData() {
    try {
      ...
      const [periods, packages, types] = await Promise.all([A.DB.getCollection('app_config/lists/price_periods'), A.DB.getCollection('app_config/lists/pkg_hotel_price'), A.DB.getCollection('app_config/lists/price_type')]);
