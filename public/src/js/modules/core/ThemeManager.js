...
const THEME_CONFIG = {
    ...
    dark: {
        ...
        classOverrides: {
            '': { color: '#808080' },
            'bkg-light': { backgroundColor: 'var(--bs-light)' }, // ★ Keep: Use Bootstrap's light background variable
            'btn-light': { backgroundColor: 'var(--bs-light)', color: '#1e293b', borderColor: '#475569' }, // ★ Keep: Light buttons with dark text and borders
            'bkg-light': { backgroundColor: 'var(--bs-white)' || 'var(--bs-light)' }, // ★ Keep: Map bkg-light to light background variable
        },
    },
