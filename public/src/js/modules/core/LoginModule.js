        ...
        <div class="erp-login-bg">
            <div class="erp-login-card">
                <div class="erp-login-head">
                    <img src="/src/images/favicon.webp" class="erp-login-logo" alt="9 Trip Logo">
                ...
                <div class="erp-login-body">
                    ...
                    <div class="erp-field">
                        ...
                        <button type="button" class="erp-field-toggle" id="btn-toggle-pass" tabindex="-1"
                                onclick="const i=getE('login-pass');const ic=getE('pass-eye');i.type=i.type==='password'?'text':'password';ic.className=i.type==='password'?'fa-solid fa-eye-slash':'fa-solid fa-eye';">
