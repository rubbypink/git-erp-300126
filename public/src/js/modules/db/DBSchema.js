    ...
    employees: {
        ...
        fields: [
            ...
            },
            {
                ...
                name: 'position',
                displayName: 'Chức Vụ',
                displayNameEng: 'Position',
                type: 'select',
                tag: 'select',
                attrs: ['required'],
                class: '',
                dataSource: ['Quản Lý', 'Trưởng Phòng', 'Nhân Viên', 'Thực Tập', 'Cộng Tác Viên'],
                validation: {
                    required: true,
                },
            },
            {
                ...
                displayNameEng: 'Department',
                type: 'select',
                tag: 'select',
                attrs: ['required'],
                class: '',
                dataSource: ['Sales', 'Operations', 'Accounting', 'HR', 'Marketing', 'IT'],
                validation: {
                    required: true,
                },
            },
            ...
            },
            {
                ...
                displayName: 'Liên Hệ Khẩn Cấp',
                displayNameEng: 'Emergency Contact',
                type: 'text',
                tag: 'input',
                attrs: [],
                class: '',
        ...
        index: ['employee_code', 'phone', 'email', 'department', 'status'],
    },

    attendance: {
        displayName: 'Chấm Công',
        displayNameEng: 'Attendance',
        primaryKey: 'id',
        fields: [
            {
                index: 0,
        ...
        index: ['employee_id', 'date', 'status'],
        foreignKeys: ['employee_id'],
    },

    salary_records: {
        displayName: 'Bảng Lương',
        displayNameEng: 'Salary Record',
        primaryKey: 'id',
        fields: [
            {
                index: 0,
                name: 'id',
                displayName: 'ID Bảng Lương',
                displayNameEng: 'Salary Record ID',
                type: 'text',
                tag: 'input',
                attrs: ['readonly'],
                class: 'fw-bold text-danger',
            ...
            },
            {
                index: 5,
                name: 'ot_hours',
                displayName: 'Giờ Tăng Ca',
                displayNameEng: 'OT Hours',
                type: 'number',
                tag: 'input',
                attrs: [],
                class: 'number',
            ...
            },
            {
                index: 6,
                name: 'ot_pay',
                displayName: 'Tiền Tăng Ca',
                displayNameEng: 'OT Pay',
                type: 'number',
                tag: 'input',
                attrs: [],
                class: 'number',
            ...
            },
            {
                ...
                displayNameEng: 'Deduction Total',
                type: 'number',
                tag: 'input',
                attrs: [],
                class: 'number',
        ...
        index: ['employee_id', 'month', 'year', 'paid'],
        foreignKeys: ['employee_id'],
    },

    bonuses: {
        displayName: 'Thưởng / Hoa Hồng',
        displayNameEng: 'Bonus',
        primaryKey: 'id',
        fields: [
            {
                index: 0,
                name: 'id',
                displayName: 'Mã Thưởng',
                displayNameEng: 'Bonus ID',
                type: 'text',
                tag: 'input',
                attrs: ['readonly'],
                class: 'fw-bold text-danger',
        ...
        index: ['employee_id', 'type', 'date', 'status'],
        foreignKeys: ['employee_id'],
    },
