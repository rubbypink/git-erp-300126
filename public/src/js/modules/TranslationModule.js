...
class TranslationModule {
    ...
    async _syncRemote() {
        ...
        try {
            ...
            const docRef = db.collection(ROOT_COL).doc(GENERAL_DOC)
                             .collection(SETTINGS_COL).doc(LANG_DOC);
            ...
            if (docSnap.exists) {
                ...
                if (data && data[this.currentLang]) {
                    ...
                    console.log('✅ Lang: Synced (app_config/general/settings/languages)');
                }
            } else {
    ...
    async update(key, value) {
        ...
        try {
            ...
            await A.DB.db.collection(ROOT_COL).doc(GENERAL_DOC)
                         .collection(SETTINGS_COL).doc(LANG_DOC)
