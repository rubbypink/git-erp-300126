    ...
    _injectStyles() {
        ...
        const css = `
            ...
            @media (max-width: 991px) {
                ...
                #notificationPanel .bg-surface-alt,
                #notificationList {
            ...
            <nav class="navbar navbar-dark p-0 erp-header-wrapper">
                <div class="erp-header-inner w-100 d-flex align-items-center">
                    ...
                    <a class="navbar-brand m-0 p-0 me-auto" href="javascript:void(0);">
                        <img id="main-logo" src="/src/images/favicon.webp" 
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end mt-2 shadow-lg border-0">
                            ...
                            <li>
                                <button class="dropdown-item py-2" type="button" onclick="A.UI.activateTab('tab-dashboard')">
                            ...
                            <li>
                                <button class="dropdown-item py-2" type="button" onclick="A.UI.activateTab('tab-data-tbl')">
                                    <i class="fa-solid fa-list text-secondary w-20px"></i> Bảng Data
                                </button>
                            </li>
                            <li>
        ...
        return `
            <div class="d-flex align-items-center gap-2">
                <form class="form-inline m-0 d-none d-md-block">
                    <div class="input-group input-group-sm flex-center gap-0 bg-surface-alt rounded overflow-hidden shadow-sm">
    ...
    _getNavTabsHTML() {
        return `
            <ul class="nav nav-tabs border-0" id="mainTabs" role="tablist">
                <li class="nav-item">
                    <button class="nav-link active fw-bold border-0 bg-transparent" data-bs-toggle="tab" data-bs-target="#tab-dashboard" >
        ...
        return `
            <div class="notification-widget dropdown position-relative me-2">
                ...
                <div class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2" id="notificationPanel" style="width: 340px; max-height: 80vh; overflow: hidden; border-radius: 12px; z-index: 1050;">
                    <div class="px-3 py-3 border-bottom bg-surface-alt d-flex justify-content-between align-items-center">
                    ...
                    <div class="border-top bg-surface-alt p-2 d-flex justify-content-between">
    ...
    _handleCustomUpdate() {
        ...
        <div class="p-2">
          ...
          <div class="mt-3 small text-info">
            <i class="fa-solid fa-info-circle me-1"></i> Hệ thống sẽ tải lại dữ liệu mới nhất từ máy chủ.
          </div>
        </div>
      `;
