...
export const ChromeMenuController = {
    ...
    config: [
        { type: 'user_info' },
        {
            ...
            id: 'btn-login-menu',
            label: 'Đăng Nhập',
            icon: 'fa-solid fa-sign-in-alt text-primary',
            actionCode: "if(typeof A !== 'undefined' && A.Auth) A.Auth.showChoiceScreen()",
        },
        {
            type: 'item',
            id: 'btn-logout-menu',
            label: 'Đăng Xuất',
            icon: 'fa-solid fa-sign-out-alt text-danger',
            inlineStyle: 'display:none;',
            actionCode: "if(typeof A !== 'undefined' && A.Auth) A.Auth.signOut()",
        },
        ...
        {
            type: 'item',
            label: 'Cập Nhật Version Mới',
            icon: 'fa-solid fa-rotate text-primary',
            actionCode: "if(typeof reloadPage === 'function') reloadPage(true)",
        },
        {
            type: 'item',
        ...
        },
        {
            ...
            id: 'btn-custom-update',
            icon: 'fa-solid fa-sync-alt text-info',
            // actionCode: "if(typeof A !== 'undefined' && A.DB) A.DB.syncDelta(null, { forceNew: true }); else L._('❌ DBManager không khả dụng');",
        },
        {
            type: 'item',
            label: 'Tạo Mới Record',
        ...
        },
        {
            type: 'item',
            label: 'Mở Calculator',
            icon: 'fa-solid fa-calculator text-success',
            actionCode: "if(typeof CalculatorWidget?.init === 'function') CalculatorWidget.init()",
        },
        {
            type: 'item',
            label: 'Cài Đặt',
            icon: 'fa-solid fa-sliders text-success',
            actionCode: "if(typeof openSettingsModal === 'function') openSettingsModal()",
        },
        { type: 'divider' },
        {
            type: 'submenu',
            ...
            children: [
                {
                    type: 'item',
                    label: 'Load Admin Page',
                    icon: 'fa-solid fa-database text-primary',
                    actionCode: "window.location.href = '/admin';",
                },
                {
                    type: 'item',
                    label: 'Xem Log',
                    icon: 'fa-solid fa-database text-primary',
                    actionCode: "A.Modal.show(null, 'Dữ Liệu Logging'); L.showUI('dynamic-modal-body');",
                },
                { type: 'divider' },
                {
                    type: 'item',
