            ...
            <div class="row g-4">
                <div class="col-12 col-lg-5">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-surface-alt fw-bold py-3">Cấu hình Hệ thống (system_settings)</div>
                        <div class="card-body">
                ...
                <div class="col-12 col-lg-7">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-surface-alt fw-bold py-3 d-flex justify-content-between align-items-center">
