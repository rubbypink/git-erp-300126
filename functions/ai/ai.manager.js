...
class AiManager {
     ...
     * @param {string} config.modelName - Tên model (vd: 'googleai/gemini-1.5-pro', 'anthropic/claude-3-5-sonnet', 'openai/gpt-4o')
     */
    constructor(config = {}) {
        this.modelName = config.modelName || 'googleai/gemini-2.5-flash';
        this.apiKey = config.apiKey || process.env.GEMINI_API_KEY_FREE;
    }
